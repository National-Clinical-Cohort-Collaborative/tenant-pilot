...
select
   ...
   (select count(*) from @cdmDatabaseSchema.ENCOUNTER JOIN @resultsDatabaseSchema.N3C_CLINICAL_COHORT ON ENCOUNTER.PATID = N3C_CLINICAL_COHORT.PATID AND ADMIT_DATE >= DATEFROMPARTS(2018,01,01)) as ROW_COUNT

UNION

select
   'CONDITION' as TABLE_NAME,
   (select count(*) from @cdmDatabaseSchema.CONDITION JOIN @resultsDatabaseSchema.N3C_CLINICAL_COHORT ON CONDITION.PATID = N3C_CLINICAL_COHORT.PATID AND REPORT_DATE >= DATEFROMPARTS(2018,01,01)) as ROW_COUNT
...
select
   ...
   (select count(*) from @cdmDatabaseSchema.DIAGNOSIS JOIN @resultsDatabaseSchema.N3C_CLINICAL_COHORT ON DIAGNOSIS.PATID = N3C_CLINICAL_COHORT.PATID AND (DX_DATE >= DATEFROMPARTS(2018,01,01) OR ADMIT_DATE >= DATEFROMPARTS(2018,01,01))) as ROW_COUNT

UNION

select
   'DISPENSING' as TABLE_NAME,
   (select count(*) from @cdmDatabaseSchema.DISPENSING JOIN @resultsDatabaseSchema.N3C_CLINICAL_COHORT ON DISPENSING.PATID = N3C_CLINICAL_COHORT.PATID AND DISPENSE_DATE >= DATEFROMPARTS(2018,01,01)) as ROW_COUNT
...
select
   ...
   (select count(*) from @cdmDatabaseSchema.LAB_RESULT_CM JOIN @resultsDatabaseSchema.N3C_CLINICAL_COHORT ON LAB_RESULT_CM.PATID = N3C_CLINICAL_COHORT.PATID AND (LAB_ORDER_DATE >= DATEFROMPARTS(2018,01,01) OR RESULT_DATE >= DATEFROMPARTS(2018,01,01))) as ROW_COUNT
...
select
   ...
   (select count(*) from @cdmDatabaseSchema.MED_ADMIN JOIN @resultsDatabaseSchema.N3C_CLINICAL_COHORT ON MED_ADMIN.PATID = N3C_CLINICAL_COHORT.PATID AND MEDADMIN_START_DATE >= DATEFROMPARTS(2018,01,01)) as ROW_COUNT

UNION

select
   'OBS_CLIN' as TABLE_NAME,
   (select count(*) from @cdmDatabaseSchema.OBS_CLIN JOIN @resultsDatabaseSchema.N3C_CLINICAL_COHORT ON OBS_CLIN.PATID = N3C_CLINICAL_COHORT.PATID AND OBSCLIN_START_DATE >= DATEFROMPARTS(2018,01,01)) as ROW_COUNT

UNION

select
   'OBS_GEN' as TABLE_NAME,
   (select count(*) from @cdmDatabaseSchema.OBS_GEN JOIN @resultsDatabaseSchema.N3C_CLINICAL_COHORT ON OBS_GEN.PATID = N3C_CLINICAL_COHORT.PATID and OBSGEN_START_DATE >= DATEFROMPARTS(2018,01,01)) as ROW_COUNT

UNION

select
   'PRESCRIBING' as TABLE_NAME,
   (select count(*) from @cdmDatabaseSchema.PRESCRIBING JOIN @resultsDatabaseSchema.N3C_CLINICAL_COHORT ON PRESCRIBING.PATID = N3C_CLINICAL_COHORT.PATID AND RX_START_DATE >= DATEFROMPARTS(2018,01,01)) as ROW_COUNT

UNION

select
   'PRO_CM' as TABLE_NAME,
   (select count(*) from @cdmDatabaseSchema.PRO_CM JOIN @resultsDatabaseSchema.N3C_CLINICAL_COHORT ON PRO_CM.PATID = N3C_CLINICAL_COHORT.PATID AND PRO_DATE >= DATEFROMPARTS(2018,01,01)) as ROW_COUNT

UNION

select
   'PROCEDURES' as TABLE_NAME,
   (select count(*) from @cdmDatabaseSchema.PROCEDURES JOIN @resultsDatabaseSchema.N3C_CLINICAL_COHORT ON PROCEDURES.PATID = N3C_CLINICAL_COHORT.PATID AND PX_DATE >= DATEFROMPARTS(2018,01,01)) as ROW_COUNT
...
select
   'VITAL' as TABLE_NAME,
   (select count(*) from @cdmDatabaseSchema.VITAL JOIN @resultsDatabaseSchema.N3C_CLINICAL_COHORT ON VITAL.PATID = N3C_CLINICAL_COHORT.PATID AND MEASURE_DATE >= DATEFROMPARTS(2018,01,01)) as ROW_COUNT
);
